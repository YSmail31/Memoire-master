...
\node at (-0.5,1.5) {P2};
%P1 DS
\draw[fill=red] (0,0) rectangle (0.8,1) ;
\draw[fill=red] (2,0) rectangle (2.8,1) ;
\draw[fill=red] (4,0) rectangle (4.8,1) ;
\draw[fill=red] (6,0) rectangle (6.8,1) ;
\draw[fill=red] (8,0) rectangle (8.8,1) ;
\draw[fill=red] (10,0) rectangle (10.8,1) ;

%P1 T1
\draw[fill=blue] (0.8,0) rectangle (1.8,1) ;
\draw[fill=blue] (2.8,0) rectangle (3.8,1) ;
\draw[fill=blue] (4.8,0) rectangle (5.8,1) ;
\draw[fill=blue] (6.8,0) rectangle (7.8,1) ;
\draw[fill=blue] (8.8,0) rectangle (9.8,1) ;
\draw[fill=blue] (10.8,0) rectangle (11.8,1) ;

%P1 T3
\draw[fill=green] (1.8,0) rectangle (2,1) ;
\draw[fill=green] (3.8,0) rectangle (4,1) ;
\draw[fill=green] (5.8,0) rectangle (6,1) ;
\draw[fill=green] (7.8,0) rectangle (8,1) ;
\draw[fill=green] (9.8,0) rectangle (10,1) ;
\draw[fill=green] (11.8,0) rectangle (12,1) ;
 ;

\draw[fill=red] (0.0,1) rectangle (1.6,2) ;
\draw[fill=yellow] (1.6,1) rectangle (3,2) ;
\draw[fill=white] (3,1) rectangle (4.2,2) ;

\draw[fill=red] (2.4,1) rectangle (5.8,2) ;
\draw[fill=yellow] (5.8,1) rectangle (7.2,2) ;
\draw[fill=white] (7.2,1) rectangle (8.4,2) ;

\draw[fill=red] (8.4,1) rectangle (10,2) ;
\draw[fill=yellow] (10,1) rectangle (11.4,2) ;
\draw[fill=white] (11.4,1) rectangle (12,2) ;
